...
export const AVAILABLE_INTERESTS = [
  { id: 'science', label: 'Science', icon: '🔬', examples: 'Veritasium, Kurzgesagt' },
  { id: 'technology', label: 'Technology', icon: '💻', examples: 'MKBHD, Linus Tech Tips' },
  { id: 'history', label: 'History', icon: '📜', examples: 'History Channel, Smithsonian' },
  { id: 'cooking', label: 'Cooking', icon: '🍳', examples: 'Gordon Ramsay, Bon Appétit' },
  { id: 'fitness', label: 'Fitness', icon: '💪', examples: 'Athlean-X, Blogilates' },
  { id: 'gaming', label: 'Gaming', icon: '🎮', examples: 'IGN, GameSpot' },
  { id: 'faith', label: 'Faith', icon: '✝️', examples: 'BibleProject, The Chosen' },
  { id: 'kids', label: 'Kids', icon: '🧒', examples: 'CoComelon, Sesame Street' },
  { id: 'nature', label: 'Nature', icon: '🌿', examples: 'BBC Earth, National Geographic' },
  { id: 'automotive', label: 'Automotive', icon: '🚗', examples: 'Doug DeMuro, Top Gear' },
  { id: 'comedy', label: 'Comedy', icon: '😂', examples: 'SNL, Key & Peele' },
  { id: 'music', label: 'Music', icon: '🎵', examples: 'VEVO, NPR Tiny Desk' },
  { id: 'makers', label: 'Makers', icon: '🛠️', examples: 'Adam Savage, Mark Rober' },
  { id: 'business', label: 'Business', icon: '💼', examples: 'Gary Vee, Alex Hormozi' },
  { id: 'art', label: 'Art & Design', icon: '🎨', examples: 'Bob Ross, Proko' },
  { id: 'sports', label: 'Sports', icon: '⚽', examples: 'ESPN, NFL Films' },
  { id: 'travel', label: 'Travel', icon: '✈️', examples: 'Rick Steves, Kara & Nate' },
  { id: 'podcasts', label: 'Podcasts', icon: '🎙️', examples: 'Joe Rogan, Lex Fridman' },
  { id: 'teen', label: 'Teen', icon: '🔥', examples: 'MrBeast, Dude Perfect' },
];
